...
public interface PushService {
     ...
     * @author weihao.liu
     */
    ResponseObj pushMessage(String content, boolean persist);
     ...
     * @author weihao.liu
     */
    ResponseObj pushMessage(String deviceType, String content, boolean persist);
     ...
     * @date 2016年12月31日
     */
    ResponseObj pushMessage(Long userId, String sendType, String content, Map<String, Object> extras, boolean persist);
     ...
     * @author weihao.liu
     */
    ResponseObj pushMessage(List<Long> userIds, String sendType, String content, Map<String, Object> extras, boolean persist);
