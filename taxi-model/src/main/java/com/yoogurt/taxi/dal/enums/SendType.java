...
public enum SendType {
    ...
    ORDER_RENT(2010, "order_rent", "您的%s消息【%d】已由【%s】接单，点击查看详情。"),
    ORDER_PAID(2011, "order_paid", "订单【%d】已完成支付。"),
    ORDER_HANDOVER(2020, "order_handover", "您的交易【%d】车主已交车，点击查看详情。"),
    ORDER_HANDOVER_REMINDER(2021, "order_handover_reminder", "您的交易【%d】已到达交车时间，请完成交车操作，以免造成不必要的损失。"),
    ORDER_HANDOVER_REMINDER1(2022, "order_handover_reminder1", "您的交易【%d】距离交车时间还有1小时，请及时完成交车操作。"),
    ORDER_HANDOVER_UNFINISHED_REMINDER(2023, "order_handover_unfinished_reminder", "您的交易【%d】车主在规定时间内未交车操作，已自动取消，点击查看详情。"),
    ORDER_GIVE_BACK(2030, "order_give_back", "您的交易【%d】车辆已归还，点击查看详情。"),
    ORDER_GIVE_BACK_REMINDER(2031, "order_give_back_reminder", "您的交易【%d】已到达还车时间，请完成还车操作以免造成不必要的损失。"),
    ORDER_GIVE_BACK_REMINDER1(2032, "order_give_back_reminder1", "您的交易【%d】距离还车时间还有1小时，请及时完成还车操作。"),
    ORDER_FINISH(2040, "order_finish", "您的交易【%d】已完成交易，点击查看详情。"),
    ORDER_TIMEOUT(2050, "order_timeout", "您的%s消息【%d】超期无人接单，已自动取消，点击查看详情。"),
